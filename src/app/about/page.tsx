...
export default function AboutPage() {
    return (
        ...
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center px-6 py-12">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl items-center">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl items-center">
                <div className="bg-gray-800 p-6 rounded-xl shadow-lg text-center hover:scale-105 transition-transform">
                    ...
                    <p className="text-gray-400 mt-2">
                        ...
                        Our adaptive system ensures that every test presents new challenges.
                    </p>
                </div>
                <div className="flex justify-center">
                    <Image
            ...
            <div className="mt-16 max-w-3xl text-center">
                ...
                <a href="/test" className="mt-6 inline-block px-6 py-3 bg-white text-blue-600 rounded-md hover:bg-gray-200 font-bold transition-all hover:scale-105">
